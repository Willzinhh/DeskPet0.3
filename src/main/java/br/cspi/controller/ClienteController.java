...
public class ClienteController {
    ...
    public ResponseEntity<List<DadosCliente>> listar(@Parameter(description = "ID do Proprietario") @PathVariable long owner_id) {
        return ResponseEntity.ok(this.ClienteService.listar(owner_id));
    }
    ...
    public ResponseEntity<DadosCliente> buscar(@Parameter(description = "ID do Proprietario") @PathVariable long owner_id,
