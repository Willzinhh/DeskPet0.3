...
public interface AgendamentoRepository extends JpaRepository<Agendamento, Integer> {
    @Query(value = "SELECT u.id as id, u.data as data, u.horario as horatio, u.observacao as observacao, u.sttus as status, u.pagamento as pagamento,u.pet_id as pet_id, u.servico_id as servico_id, u.funcionario_id as funcionario_id, u.owner_id as owner_id " +
